      ...
      <main className="pt-20">
        ...
        <section className="py-12 text-center px-6">
          <div className="container mx-auto max-w-4xl">
            <h1 className="text-4xl sm:text-5xl font-extrabold mb-3">Internships at Softforge Technology</h1>
            <p className="text-lg text-white/85 mb-6">Hands-on internships for students and freshers — learn by building real projects with mentors.</p>
            ...
            <div className="mx-auto max-w-xl flex items-center gap-3 bg-white/6 rounded-full px-4 py-2">
              ...
              />
              <button onClick={() => setQuery('')} className="px-4 py-2 rounded-full bg-white text-purple-900 font-semibold">Clear</button>
            </div>
        ...
        <section className="py-8 container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((intern) => (
              <div key={intern.id} className="p-6 rounded-2xl bg-white/5 hover:bg-white/6 transition">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <h3 className="text-lg font-semibold">{intern.title}</h3>
                    <p className="text-sm text-white/75 mt-2">{intern.description}</p>
                  ...
                  <div className="text-right flex-shrink-0">
                    <button
                      ...
                      className="inline-block px-4 py-2 rounded-md bg-white text-purple-900 font-semibold">
                      Apply
                    </button>
        ...
        <section className="py-12 bg-white/6">
          <div className="container mx-auto px-6 text-center">
            <h3 className="text-2xl font-bold mb-2">Want to intern with us?</h3>
...
// Add modal component inside same file
...
const ApplyModal: React.FC<ApplyModalProps> = ({ open, onClose, role }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-50">
      <div className="bg-purple-600 text-black w-full max-w-lg p-6 rounded-xl shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="flex justify-end gap-3 mt-4">
            ...
            <button type="submit" className="px-4 py-2 bg-green-400 text-white rounded">Submit</button>
          </div>
        </form>
      </div>
    </div>
...
const EmailModal: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-50">
      <div className="bg-purple-500 text-black w-full max-w-md p-6 rounded-xl shadow-xl">
