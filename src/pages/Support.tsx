          ...
          <aside className="space-y-6">
            <div className="p-6 rounded-xl bg-white/5 text-center">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2 justify-center"><Phone size={16} /> <a href="tel:+912345678901" className="underline">+91 23456 78901</a></div>
                <div className="flex items-center gap-2 justify-center"><Mail size={16} /> <a href="mailto:support@softforge.com" className="underline">support@softforge.com</a></div>
