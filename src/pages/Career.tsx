...
const jobs = [
  /* . */
  {
    ...
    location: 'Nanded, India (Hybrid)',
    type: 'Full-time',
    seniority: 'Mid • Senior',
    summary: 'Build delightful, accessible user interfaces using React, TypeScript and Tailwind.'
  },
  {
    id: '2',
    ...
    type: 'Full-time',
    seniority: 'Mid',
    summary: 'Design reliable APIs, databases and background processing pipelines.'
  },
  {
    id: '3',
    title: 'DevOps / Cloud Engineer',
    location: 'Nanded, India (On-site)',
    type: 'Full-time',
    seniority: 'Mid • Senior',
    summary: 'Own our cloud infrastructure, CI/CD and reliability story.'
  },
  {
    id: '4',
    ...
    type: 'Full-time',
    seniority: 'Mid • Senior',
    summary: 'Build delightful, accessible user interfaces using React, TypeScript and Tailwind.Design reliable APIs, databases and background processing pipelines.'
  },{
    id: '5',
...
const Career: React.FC = () => {
  ...
  function submitApplication(e: React.FormEvent) {
    ...
    // Simulate an API call. Replace this with a real POST in production.
    setTimeout(() => {
      setSubmitting(false);
      setShowSuccess(true);
      ...
      // Automatically hide success and close modal after a short delay
      setTimeout(() => {
            ...
            <div className="w-full max-w-xl rounded-xl bg-gradient-to-b from-white/6 to-white/4 p-6 relative">
              ...
              <form onSubmit={submitApplication} className="mt-4 grid grid-cols-1 gap-3">
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  <a href="/apply-template.pdf" className="text-sm underline">Download CV template</a>
                </div>
              </form>
